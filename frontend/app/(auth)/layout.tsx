...
export default function AuthLayout({
  ...
  return (
    <main className='lg:grid lg:grid-cols-2 xl:grid-cols-5 min-h-dvh divide-x divide-zinc-300/60 dark:divide-zinc-700/50'>
      <section className='h-full xl:col-span-3'>{children}</section>
      <section className='dot-overlay md:grid xl:col-span-2 md:place-items-center bg-zinc-100 dark:bg-zinc-900 hidden'>
